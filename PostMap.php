...
<html>
    ...
    <div class="row">
      ...
      <?php include 'parts/navbar.php';  ?>
        ...
        <!------------------ MAP ------------------------>
        <h4 style="font-weight: bold; text-align: center;">Post</h4>
        <h5 style="font-weight: bold;">Pinned Location:</h5>
        <div id="map">
                ...
                if($numrecords != 0)
                {
                  while ($row = mysqli_fetch_assoc($result)) 
                  {
                        ...
                        <div class="row">
                            ...
                            <!-- User Info -->
                            <p>'.$row['firstName'] . ' ' . $row['lastName'] .' at '.$row['location_name'].'</p>
                            <p>'. $row['created_at'].'</p>
                            </div>
                        </div>
                        <div class="row">
