...
<?php 
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        $sql = "INSERT INTO user_posts (type, title, text, image, likes, email, location_name, latitude, longitude) VALUES ('image', '$title', '$text', '$destination', 0, '$email', '$locationName', '$latitude', '$longitude')";
...
<html>
    ...
    <title>Atlas | New Image Post</title>      
    </head>
    <body>
    ...
    <div class="row">
      ...
      <?php include 'parts/navbar.php'; ?>
        ...
        <div class="post-box">
            <h5 style="font-weight: bold; text-align:center;">Upload a Photo</h5>
            <form action="/Atlas/imagepost.php" method="post" style="font-size: 16px;" enctype="multipart/form-data">
